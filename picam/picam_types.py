""" 
.. module: picam.picam_types
   :platform: Windows
.. moduleauthor:: Daniel Dietze <daniel.dietze@berkeley.edu> 

Defines data types, enums and some structures to be used with the main module :py:mod:`picam`!

As there are no enums in python, I have implemented each enumeration as dictionary having the same name and entries as the library version. In addition, for each enum *XX*, there is a lookup table called *XXLookup*, which takes the enum value as key and returns the name of the entry. For a complete list of valid enumeration values, please refer to the **PICam SDK manual**. 
...
class PicamCameraID(ctypes.Structure):
    """
    :var piint model:
    :var piint computer_interface:
    :var pichar[PicamStringSize["SensorName"]] sensor_name:
    :var pichar * PicamStringSize["SerialNumber"] serial_number:
    """
...
class PicamFirmwareDetail(ctypes.Structure):
    """
    :var pichar[PicamStringSize["FirmwareName"]] name:
    :var pichar[PicamStringSize["FirmwareDetail"]] detail:
    """
...
class PicamRois(ctypes.Structure):
    """
    :var ctypes.POINTER(PicamRoi) roi_array:
    :var piint roi_count:
    """
...
class PicamModulation(ctypes.Structure):
    ...
    :var piflt frequency:
    :var piflt phase:
    :var piflt output_signal_frequency:
    """
...
class PicamModulations(ctypes.Structure):
    """
    :var ctypes.POINTER(PicamModulation) modulation_array:
    :var piint modulation_count:
    """
...
class PicamCollectionConstraint(ctypes.Structure):
    ...
    :var piint scope:
    :var piint severity:
    :var ctypes.POINTER(piflt) values_array:
    :var piint values_count:
    """
...
class PicamRangeConstraint(ctypes.Structure):
    ...
    :var piflt maximum:
    :var piflt increment:
    :var ctypes.POINTER(piflt) excluded_values_array:
    :var piint excluded_values_count:
    :var ctypes.POINTER(piflt) outlying_values_array:
    :var piint outlying_values_count:
    """
    _fields_ = [("scope", piint), 
                ("severity", piint),
                ("empty_set", pibln),
...
class PicamRoisConstraint(ctypes.Structure):
    ...
    :var pibln empty_set:
    :var piint rules:
    :var piint maximum_roi_count:
    :var PicamRangeConstraint x_constraint:
    :var PicamRangeConstraint width_constraint:
    :var ctypes.POINTER(piint) x_binning_limits_array:
    :var piint x_binning_limits_count:
    :var PicamRangeConstraint y_constraint:
    :var PicamRangeConstraint height_constraint:
    :var ctypes.POINTER(piint) y_binning_limits_array:
    :var piint y_binning_limits_count:
    """
    _fields_ = [("scope", piint),
                ("severity", piint),
                ("empty_set", pibln),
...
class PicamPulseConstraint(ctypes.Structure):
    ...
    :var piint severity:
    :var pibln empty_set:
    :var PicamRangeConstraint delay_constraint:
    :var PicamRangeConstraint width_constraint:
    :var piflt minimum_duration:
    :var piflt maximum_duration:
    """
    _fields_ = [("scope", piint),
                ("severity", piint),
                ("empty_set", pibln),
...
class PicamModulationsConstraint(ctypes.Structure):
    ...
    :var piint severity:
    :var pibln empty_set:
    :var piint maximum_modulation_count:
    :var PicamRangeConstraint duration_constraint:
    :var PicamRangeConstraint frequency_constraint:
    :var PicamRangeConstraint phase_constraint:
    :var PicamRangeConstraint output_signal_frequency_constraint:
    """
    _fields_ = [("scope", piint),
                ("severity", piint),
                ("empty_set", pibln),
...
class PicamAvailableData(ctypes.Structure):
    """
    :var pivoid initial_readout:
    :var pi64s readout_count:
    """
